           ...
           <h1>Database</h1>
            ...
            <div className="tab flex justify-between items-center my-8 border-b border-line ">
              ...
              <li className='tab-link '><Link to="/database/student">Student</Link></li>
                ...
                <li className='tab-link debugger'><Link to="/database/checker">Checker</Link></li>
              </ul>
                <button className='btn btn--accent flex items-center gap-2'>Just a regular Button<FiPlus/></button>
            </div>
            <ul className="flex flex-col gap-5">
                ...
                <li><button onClick={handleToolDelete} className='btn w-1/2 btn-form bg-hazard'>ModalDelete</button></li>
