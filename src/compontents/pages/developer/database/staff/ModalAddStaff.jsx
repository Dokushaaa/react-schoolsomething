...
const ModalAddStaff = ({setStaffInfo}) => {
    const handleCloseStaff = () => setStaffInfo(false);
  return (
  <>
  <ModalWrapper> 
  <div className="main-modal w-[350px] bg-secondary text-content h-full">
            <div className="modal-header p-4 realtive">
                ...
                <button className='absolute top-[25px] right-4' onClick={handleCloseStaff}><LiaTimesSolid/></button>
                </div>
