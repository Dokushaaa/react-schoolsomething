...
const StaffInformation = ({ itemData, showInfo, setShowInfo }) => {
				...
				<div className="p-8">
					<div className="text-center mb-8">
						<img
							...
							alt=""
						/>
						<h3 className="mb-1">{itemData.staff_name}</h3>
						<div className="flex flex-col ">
							<small className="opacity-60  text-base">
								{itemData.staff_class}
							</small>
							<small className="opacity-60 text-xs">
								{itemData.staff_email}
							</small>
						</div>
					...
					<div className="grid grid-cols-2 gap-4 mt-8">
						<div className="info-box">
							<h4>Age</h4>
							<p className="text-xs">{itemData.staff_age}</p>
						</div>
						<div className="info-box">
							<h4>Gender</h4>
							<p className="text-xs">{itemData.staff_gender}</p>
						</div>
						<div className="info-box">
							<h4>Birthday</h4>
